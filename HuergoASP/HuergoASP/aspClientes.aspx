<%@ Page Language="C#" MasterPageFile="~/Huergo.Master" AutoEventWireup="true" CodeBehind="aspClientes.aspx.cs" Inherits="HuergoASP.aspClientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoDeMisPaginas" runat="server">
        ...
        <asp:GridView ID="gvClientes" runat="server" CellPadding="4" GridLines="None" Height="357px" OnRowCommand="gvClientes_RowCommand1" Width="964px">
