<%@ Page Language="C#" MasterPageFile="~/Huergo.Master" AutoEventWireup="true" CodeBehind="aspVehiculos.aspx.cs" Inherits="HuergoASP.aspVehiculos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contenidoDeMisPaginas" runat="server">
    ...
    <asp:GridView ID="gvVehiculos" runat="server" CellPadding="4" GridLines="None" Height="357px" OnRowCommand="gvVehiculos_RowCommand" Width="964px">
    ...
    <asp:Button ID="btAgregar" runat="server" OnClick="btAgregar_Click" Text="Agregar" Width="143px" />
</asp:Content>
